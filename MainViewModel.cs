...
public sealed class MainViewModel : ObservableObject
{
    ...
    private InspectionRecord? _lastInspection;public InspectionRecord? LastInspection{get=>_lastInspection;set{Set(ref _lastInspection,value);Raise(nameof(LastResultText));}}public string LastResultText=>LastInspection is null?"-":LastInspection.Passed?"PASS":$"NG {LastInspection.NgCode}";
